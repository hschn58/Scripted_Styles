...
# Get our base shape
x_base, y_top_base, y_bot_base = base_shape()
...
plt.savefig(unique_filename(os.path.dirname(os.path.abspath(__file__))+'/collage2.jpg'), transparent=True, dpi=2400, bbox_inches='tight', pad_inches=0.0)
