...
def render_quilt_image(colormap, seed, dpi, num=14, n_shapes=4000, figlen=figlen):
    """
...
#postprocess to get rid of null values
...
filename = unique_filename( os.path.join(dirname, 'plane_windows_good.jpg'))
# Display or save
