...
ext='png'
# Load the image
image_path = f'\'Sail the Static-Gone Sailin\'\'/Images/{name}.{ext}'  # Update this to the path of your image
...
# Save the result
output_path = f'\'Sail the Static-Gone Sailin\'\'/Images/{name}_out.{ext}'  # Update this to where you want to save the modified image
